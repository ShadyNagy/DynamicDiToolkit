...
public interface IServiceFactory
{
	...
	object GetService(Type genericServiceTypeDefinition, string className);
	...
	object GetService(Type genericServiceTypeDefinition, string entityName, string entitiesAssembly);
